...
init_sprite_chr (void)
{
  ...
  CpuSet ( sprite_youTiles, oam + sprite_point1TilesLen / 2 * 7, (COPY16 | sprite_youTilesLen / 2));
  CpuSet ( sprite_you2Tiles, oam + sprite_point1TilesLen / 2 * 7 + sprite_youTilesLen/2, (COPY16 | sprite_youTilesLen / 2));
